...
public class server {
    ...
    public static void main(String[] args) {
        ...
        try 
        {
            ...
            while (true) {   // ciclo al infinito para elfuncionamiento del server esperando clientes
                ...
                while ((cadena = fromClient.readLine()) != null) { //ciclo esperando que no se reciba nada
